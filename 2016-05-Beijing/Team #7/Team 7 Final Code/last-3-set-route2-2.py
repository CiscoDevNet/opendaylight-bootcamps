...
def add_static_route(device_name, destination_network, next_hop_address, discription ,print_tag):
    ...
    static_route_create(device_name, destination_network, next_hop_address, discription)
    if print_tag == 1:
...
def main():   
    ...
    add_static_route(device_1, destination_network, next_hop_address, discription, 0)
    #device_2
    next_hop_address = '198.18.1.34'
    discription = 'for flow 1: to device_5'
    add_static_route(device_2, destination_network, next_hop_address, discription, 0)
    #device_8
    next_hop_address = '10.0.28.2'
    discription = 'for flow 1: to device_2'
    add_static_route(device_8, destination_network, next_hop_address, discription, 0)
    #display
