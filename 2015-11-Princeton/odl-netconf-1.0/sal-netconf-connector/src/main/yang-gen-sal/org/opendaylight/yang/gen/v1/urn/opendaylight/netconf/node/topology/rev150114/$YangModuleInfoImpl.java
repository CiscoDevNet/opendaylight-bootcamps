...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "netconf-node-topology";
    private final String namespace = "urn:opendaylight:netconf-node-topology";
    private final String revision = "2015-01-14";
    private final String resourcePath = "/META-INF/yang/netconf-node-topology.yang";
