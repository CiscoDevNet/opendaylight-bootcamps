...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "odl-sal-netconf-connector-cfg";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:md:sal:connector:netconf";
    private final String revision = "2013-10-28";
    private final String resourcePath = "/META-INF/yang/odl-sal-netconf-connector-cfg.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.threadpool.rev130409.$YangModuleInfoImpl.getInstance());
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.netconf.rev140408.$YangModuleInfoImpl.getInstance());
