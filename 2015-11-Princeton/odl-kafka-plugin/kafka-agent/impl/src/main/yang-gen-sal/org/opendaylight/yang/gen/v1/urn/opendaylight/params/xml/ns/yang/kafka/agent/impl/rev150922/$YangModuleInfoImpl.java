...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "kafka-agent-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:kafka-agent:impl";
    private final String revision = "2015-09-22";
    private final String resourcePath = "/META-INF/yang/kafka-agent-impl.yang";
