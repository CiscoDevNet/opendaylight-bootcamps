...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "kafka-agent";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:kafka-agent";
    private final String revision = "2015-09-22";
    private final String resourcePath = "/META-INF/yang/kafka-agent.yang";
