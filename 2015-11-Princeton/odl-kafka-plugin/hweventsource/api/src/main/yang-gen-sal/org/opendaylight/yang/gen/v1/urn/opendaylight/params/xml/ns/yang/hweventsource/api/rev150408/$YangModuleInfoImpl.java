...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "hweventsource";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:hweventsource:api";
    private final String revision = "2015-04-08";
    private final String resourcePath = "/META-INF/yang/hweventsource.yang";
